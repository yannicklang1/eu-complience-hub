            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-white/45 text-base sm:text-lg leading-relaxed max-w-2xl">
                  Software, auditors, law firms &amp; consultants for your
                  EU compliance &mdash; curated and filterable by regulation.
                </p>
              </div>
            </div>
        ...
        <div className="bg-amber-50 border-b border-amber-200">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 py-3 flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-2 text-sm text-amber-800">
              ...
              <span>
                <strong>As of: February 2026.</strong>{" "}
                Prices and features are subject to change.
              </span>
            </div>
            <a
              href="mailto:hello@eu-compliance-hub.eu?subject=Directory-Correction"
            ...
            {filtered.length > 0 ? (
              ...
              >
                ...
                <p className="text-sm text-[#7a8db0] mb-6 max-w-md mx-auto">
                  Your filter selection returned no matches. Try adjusting
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-6 lg:px-12 text-center">
            ...
            >
              ...
              >
                Reach decision-makers who are actively searching for
                compliance solutions. Our curated directory offers premium
                placements with guaranteed visibility.
              </motion.p>
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Clicks & impressions",
                  },
                  {
                    icon: "\uD83C\uDFAF",
                    label: "Target audience",
                    desc: "Compliance decision-makers",
                  },
                ].map((feature) => (
                  <div
                    key={feature.label}
              ...
              <motion.div variants={fadeInUp}>
                <a
                  href="mailto:hello@eu-compliance-hub.eu?subject=Directory-Listing"
                ...
                <p className="font-mono text-[11px] text-white/20 mt-6 tracking-wide">
                  Non-binding enquiry. Response within 24 hours.
                </p>
              </motion.div>
            </motion.div>
          </div>
