...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  EHDS: "#ec4899",
  ePrivacy: "#8b5cf6",
  "Product Liability": "#d97706",
  Liability: "#b91c1c",
  Platform: "#FACC15",
};

export default function FAQContentEN({ faqData }: { faqData: FAQItem[] }) {
        ...
        <section className="relative pt-32 pb-12 overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-6 text-center">
            ...
            <p className="text-slate-400 text-base sm:text-lg leading-relaxed max-w-xl mx-auto">
              Answers to the most important questions about EU regulations — clearly explained for decision-makers and compliance officers.
            </p>
          </div>
        </section>
        ...
        <section className="px-6 pb-20">
          ...
          <div className="max-w-3xl mx-auto mt-12 rounded-2xl border border-yellow-400/10 bg-yellow-400/5 p-6 sm:p-8 text-center">
            ...
            <p className="text-sm text-slate-400 mb-5">
              Get a free compliance report — personalised for your company.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link
                href="/en/tools/regulierung-finder"
