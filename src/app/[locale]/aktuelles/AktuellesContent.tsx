...
/* ══════════════════════════════════════════════════════════════
   Aktuelles / Compliance News — Timeline-style news feed
   ══════════════════════════════════════════════════════════════ */

type FilterType = "all" | "gesetz" | "frist" | "urteil" | "update" | "leitlinie";

const TYPE_META: Record<string, { label: string; color: string; icon: string }> = {
  gesetz: { label: "Gesetzgebung", color: "#1e40af", icon: "📜" },
  frist: { label: "Frist / Deadline", color: "#dc2626", icon: "⏰" },
  urteil: { label: "Urteil", color: "#7c3aed", icon: "⚖️" },
  update: { label: "Update", color: "#059669", icon: "🔄" },
  leitlinie: { label: "Leitlinie", color: "#ea580c", icon: "📋" },
};
...
export default function AktuellesContent({
  newsItems,
}: {
  newsItems: NewsItem[];
}) {
        ...
        <section className="relative pt-32 pb-12 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-slate-400 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Wichtige Entwicklungen, neue Gesetze und kommende Fristen —
              kompakt zusammengefasst für Entscheider und Compliance-Verantwortliche.
            </p>
          </div>
        </section>
        ...
        <section className="px-6 pb-20">
          <div className="max-w-3xl mx-auto">
            ...
            <SocialShareBar
              ...
              dark
              label="News teilen"
              sublabel="Teilen Sie aktuelle Compliance-News mit Ihrem Netzwerk"
            />
            ...
            <div className="mt-4 rounded-2xl border border-yellow-400/10 bg-yellow-400/5 p-6 sm:p-8 text-center">
              ...
              <p className="text-sm text-slate-400 mb-5">
                Abonnieren Sie unser Compliance-Briefing — nur bei kritischen
                Fristen und Gesetzesänderungen, max. 3×/Monat.
              </p>
