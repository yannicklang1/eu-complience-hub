      ...
      <div className="w-full max-w-[380px] relative z-10">
        ...
        <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm">
          <div className="px-6 py-4 border-b border-white/[0.06]">
            <h1 className="text-[13px] font-semibold text-white/70">Passwort zurücksetzen</h1>
          </div>
          ...
          <div className="p-6">
            {state === "success" ? (
              <div className="text-center py-2">
                ...
                <h3 className="text-[13px] font-semibold text-white/70 mb-1.5">E-Mail gesendet</h3>
                ...
                <Link
                  href="/auth/login"
                  className="text-[12px] text-white/30 hover:text-yellow-400/70 transition-colors"
                >
