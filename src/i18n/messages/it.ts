...
const it: Messages = {
  ...
  home: {
    ...
    whyUs: {
      ...
      subtitle: "I regolamenti UE sembrano Kafka in tedesco legale. Li leggiamo per te — e distilliamo l'essenziale in passi d'azione chiari.",
      benefits: [
        ...
        { title: "Austria + UE", desc: "Implementazioni nazionali incluse" },
      ],
