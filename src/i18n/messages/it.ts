  ...
  home: {
    ...
    tools: {
      ...
      items: [
        ...
        { title: "Valutazione maturità", desc: "Valuta la tua maturità di conformità in 5 categorie e ottieni una valutazione da A a E in pochi minuti.", cta: "Valuta maturità", badge: "Nuovo" },
    ...
    /* Come funziona */
    howItWorks: {
      aria: "Come funziona EU Compliance Hub",
      sectionLabel: "Come funziona",
      title: "Dal regolamento all'implementazione — in tre passaggi",
      subtitle: "Tutti i regolamenti UE, spiegati chiaramente e per ogni paese. Uso gratuito. Solo se vuoi un report PDF su misura si applica un pagamento unico.",
      ctaTools: "Inizia con gli strumenti gratuiti",
      ctaReport: "Vedi il report di conformità",
      steps: [
        {
          tag: "Capire",
          title: "Ogni regolamento — in linguaggio chiaro",
          desc: "Leggiamo la Gazzetta ufficiale per te e prepariamo 18 regolamenti visivamente: panoramica, obblighi, scadenze, sanzioni. Con fonti e data dell'ultima revisione.",
          price: "Gratuito — tutte le guide e glossario",
          priceColor: "#16a34a",
        },
        {
          tag: "Per paese",
          title: "Scegli il tuo paese",
          desc: "I regolamenti UE sono recepiti a livello nazionale. Scegli AT, DE o uno degli altri 25 paesi UE e vedi la legge nazionale applicabile, l'autorità competente e le sanzioni.",
          price: "Gratuito — 27 paesi UE coperti",
          priceColor: "#16a34a",
        },
        {
          tag: "Agire",
          title: "Fai un check od ottieni un report",
          desc: "Usa i nostri strumenti interattivi (Finder, NIS2, Maturità, Responsabilità…) o evita la ricerca: ottieni un report PDF personalizzato con raccomandazioni concrete e partner di implementazione verificati.",
          price: "Strumenti gratis · Report PDF 149 € unico",
          priceColor: "#FACC15",
        },
      ],
    },
    ...
    /* Report CTA */
    report: {
      badge: "Il nostro unico strumento premium",
      title1: "Il tuo",
      title2: "Report di conformità.",
      subtitle: "Questionario interattivo invece di ore di ricerca — clicca e ricevi un report PDF su misura: quali regolamenti si applicano, cosa fare concretamente e quali partner possono aiutare con l'implementazione.",
      benefit1Title: "14 regolamenti esaminati",
      benefit1Desc: "Su misura per settore, dimensione e attività",
      benefit2Title: "Raccomandazioni concrete",
      benefit2Desc: "Cosa fare — prioritizzato per fase e urgenza",
      benefit3Title: "Partner di implementazione",
      benefit3Desc: "Consulenti, auditor e software selezionati",
      ctaCreate: "Crea report di conformità",
      ctaSubtitle: "Anteprima gratuita. Report PDF completo: 149 € — pagamento unico, senza abbonamento.",
      ...
      previewMore: "+3 altri",
      previewCost: "Prossima scadenza",
      previewCostRange: "166 giorni",
      previewCostLabel: "Priorità: NISG 2026 (1 ottobre 2026)",
