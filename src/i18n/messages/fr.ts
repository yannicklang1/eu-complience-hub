  ...
  home: {
    ...
    tools: {
      ...
      items: [
        ...
        { title: "Évaluation de maturité", desc: "Évaluez votre maturité de conformité dans 5 catégories et obtenez une note de A à E en quelques minutes.", cta: "Évaluer la maturité", badge: "Nouveau" },
    ...
    /* Comment ça marche */
    howItWorks: {
      aria: "Comment fonctionne EU Compliance Hub",
      sectionLabel: "Comment ça marche",
      title: "De la réglementation à la mise en œuvre — en trois étapes",
      subtitle: "Toutes les réglementations UE, clairement expliquées et spécifiques à chaque pays. Gratuit. Seul le rapport PDF personnalisé est payant — paiement unique.",
      ctaTools: "Commencer avec les outils gratuits",
      ctaReport: "Voir le rapport de conformité",
      steps: [
        {
          tag: "Comprendre",
          title: "Chaque réglementation — en langage clair",
          desc: "Nous lisons le Journal officiel à votre place et préparons 18 réglementations visuellement : aperçu, obligations, échéances, sanctions. Sources et date de dernière révision.",
          price: "Gratuit — tous les guides & glossaire",
          priceColor: "#16a34a",
        },
        {
          tag: "Par pays",
          title: "Choisissez votre pays",
          desc: "Les réglementations UE sont transposées nationalement. Choisissez AT, DE ou l'un des 25 autres pays UE et voyez la loi nationale applicable, l'autorité compétente et les sanctions.",
          price: "Gratuit — 27 pays UE couverts",
          priceColor: "#16a34a",
        },
        {
          tag: "Agir",
          title: "Effectuez un check ou obtenez un rapport",
          desc: "Utilisez nos outils interactifs (Finder, NIS2, Maturité, Responsabilité…) ou évitez les recherches : obtenez un rapport PDF personnalisé avec recommandations concrètes et partenaires d'implémentation validés.",
          price: "Outils gratuits · Rapport PDF 149 € unique",
          priceColor: "#FACC15",
        },
      ],
    },
    ...
    /* Report CTA */
    report: {
      badge: "Notre seul outil premium",
      title1: "Votre",
      title2: "Rapport de conformité.",
      subtitle: "Questionnaire interactif au lieu d'heures de recherche — cliquez pour obtenir un rapport PDF sur mesure : quelles réglementations s'appliquent, quoi faire concrètement et quels partenaires peuvent aider à la mise en œuvre.",
      benefit1Title: "14 réglementations examinées",
      benefit1Desc: "Adapté au secteur, à la taille & à l'activité",
      benefit2Title: "Recommandations concrètes",
      benefit2Desc: "Que faire — priorisé par phase et urgence",
      benefit3Title: "Partenaires de mise en œuvre",
      benefit3Desc: "Consultants, auditeurs et logiciels sélectionnés",
      ctaCreate: "Créer un rapport de conformité",
      ctaSubtitle: "Aperçu gratuit. Rapport PDF complet : 149 € — paiement unique, sans abonnement.",
      ...
      previewCost: "Prochaine échéance",
      previewCostRange: "166 jours",
      previewCostLabel: "Priorité : NISG 2026 (1er octobre 2026)",
