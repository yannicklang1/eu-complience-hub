...
const fr: Messages = {
  ...
  home: {
    ...
    whyUs: {
      ...
      subtitle: "Les règlements européens se lisent comme du Kafka en langage juridique. Nous les lisons pour vous — et en distillons l'essentiel en étapes d'action claires.",
      benefits: [
        ...
        { title: "Autriche + UE", desc: "Transpositions nationales incluses" },
      ],
