  ...
  home: {
    ...
    tools: {
      ...
      items: [
        ...
        { title: "Maturity Check", desc: "Assess your compliance maturity across 5 categories and get an A–E rating in minutes.", cta: "Check maturity", badge: "New" },
    ...
    /* How it works */
    howItWorks: {
      aria: "How EU Compliance Hub works",
      sectionLabel: "How it works",
      title: "From the regulation to implementation — in three steps",
      subtitle: "All EU regulations, clearly explained and country-specific. Free to use. Only if you want a tailored PDF report does a one-time fee apply.",
      ctaTools: "Start with free tools",
      ctaReport: "See the Compliance Report",
      steps: [
        {
          tag: "Understand",
          title: "Every regulation — in plain language",
          desc: "We read the Official Journal for you and prepare 18 regulations visually: overview, obligations, deadlines, penalties. With sources and last review date.",
          price: "Free — all guides & glossary",
          priceColor: "#16a34a",
        },
        {
          tag: "Country-specific",
          title: "Pick your country",
          desc: "EU regulations are transposed nationally. Pick AT, DE or any of the 25 other EU countries and see which national law applies, who the competent authority is and what penalties apply.",
          price: "Free — 27 EU countries covered",
          priceColor: "#16a34a",
        },
        {
          tag: "Act",
          title: "Run a check or get a report",
          desc: "Use our interactive tools (Regulation Finder, NIS2 Check, Maturity Check, Liability Checker …) or skip the research: get a personalised PDF report with concrete next steps and vetted implementation partners.",
          price: "Tools free · PDF report €149 one-time",
          priceColor: "#FACC15",
        },
      ],
    },
    ...
    whyUs: {
      ...
      subtitle: "EU regulations read like Kafka in legalese. We read them for you — and distill the essentials into clear action steps.",
      benefits: [
        ...
        { title: "EU-wide", desc: "All 27 member states covered" },
      ],
      freeBadge: "100% free",
    ...
    /* Report CTA */
    report: {
      badge: "Our only premium tool",
      title1: "Your personal",
      title2: "Compliance Report.",
      subtitle: "Interactive questionnaire instead of hours of research — click through, and receive a tailored PDF report: which regulations apply to you, what to do next and which partners can help with implementation.",
      benefit1Title: "14 regulations reviewed",
      benefit1Desc: "Tailored to industry, size & activity",
      benefit2Title: "Concrete next-step actions",
      benefit2Desc: "What to do — prioritised by phase and urgency",
      benefit3Title: "Implementation partners",
      benefit3Desc: "Curated consultants, auditors and software vendors",
      ctaCreate: "Create Compliance Report",
      ctaSubtitle: "Free preview. Full PDF report: €149 — one-time, no subscription.",
      ...
      previewMore: "+3 more",
      previewCost: "Next deadline",
      previewCostRange: "166 days",
      previewCostLabel: "Priority: NISG 2026 (1 October 2026)",
