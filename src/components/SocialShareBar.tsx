...
export default function SocialShareBar({
  ...
  dark = false,
  label = "Guide teilen",
  sublabel = "Teilen Sie diesen Guide mit Kollegen und Entscheidern",
}: SocialShareBarProps) {
  ...
  const channels = [
    ...
    },
    {
      ...
      href: `mailto:?subject=${encodeURIComponent(shareText)}&body=${encodeURIComponent(`Schau dir diesen Compliance-Guide an:\n\n${title}\n${fullUrl}`)}`,
    },
  ];
