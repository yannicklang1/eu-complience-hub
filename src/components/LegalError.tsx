...
/**
 * Shared error boundary for legal pages (Impressum, Datenschutz, Haftungsausschluss).
 * Re-exported by each legal page's error.tsx for consistent error UX.
 */
export default function LegalError({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#040a18] px-6">
