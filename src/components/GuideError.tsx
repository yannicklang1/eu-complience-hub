 ...
 * Re-exported by each guide's error.tsx for consistent error UX.
 */
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#060c1a] px-6">
      <div className="text-center max-w-lg">
        ...
        <h1 className="font-[Syne] font-[800] text-2xl sm:text-3xl text-white mb-4">
          Guide konnte nicht geladen werden
        </h1>
        <p className="text-white/45 text-sm leading-relaxed mb-8">
          Beim Laden dieses Compliance-Guides ist ein unerwarteter Fehler
